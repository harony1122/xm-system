...
if(!omar.guild.member(omar.author).hasPermission("SEND_MESSAGE")) return omar.reply("**You Don't Have ` MANAGE_CHANNELS ` Permission**");
if(!omar.guild.member(client.user).hasPermission("SEND_MESSAGE")) return omar.reply("**I Don't Have ` MANAGE_CHANNELS ` Permission**");
